package com.movie.movieTicket.exception;

import com.movie.movieTicket.dto.ErrorResponseDto;
...
//	}
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        List<String> errorMessage = CollectionUtils.isEmpty(validationList) ? Collections.singletonList("Error in validating fields") : validationList;
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(errorCode, errorMessage);
